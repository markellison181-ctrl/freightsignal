...
export const metadata: Metadata = {
  title: "Terms of Service — FreightSignal",
  description: "Terms of Service for FreightSignal newsletter by SignalStack Media.",
};
    ...
    <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
      ...
      <div className="space-y-8 text-gray-300 leading-relaxed text-sm">
        <section>
          ...
          <p className="mt-3">By accessing FreightSignal (freightsignal.io), subscribing to our newsletter, or using any of our services, you agree to be bound by these Terms and our Privacy Policy.</p>
        </section>
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">2. Services</h2>
          <p>FreightSignal is a niche intelligence newsletter service providing analysis of freight and logistics market trends, rate movements, carrier data, and supply chain intelligence. Our services include free and paid newsletter subscriptions, web-based content and archives, searchable market data (Pro and Enterprise tiers), and API access (Enterprise tier).</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>SignalStack Media LLC<br />1209 Orange St, Wilmington, DE 19801<br />Email: hello@freightsignal.io</p>
        </section>
      </div>
    </div>
  );
